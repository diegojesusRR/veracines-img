    ...
    return (
        <div className="flex w-full p-4 text-center items-center flex-1">
            <div className="flex-1 flex flex-row items-center">
                ...
                <span className="ml-2">
            <p className={`text-${cine.color} italic text-sm`}>{direccion}</p>
            <p className={`text-${cine.color} italic text-sm`}>{localidad}</p>
        </span>
            </div>
            <div className="flex-1">
                <p className={`text-${cine.color} italic text-sm`}>Tlfn: 660 391 365</p>
                <p className={`text-${cine.color} italic text-sm`}>www.veracines.es</p>
            </div>
            <div className="flex-1 flex max-w-2/3 items-center">
                <p className={`text-${cine.color} italic text-sm`}>Colabora Excmo. Ayuntamiento de Vera</p>
